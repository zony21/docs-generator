...
export const INPUT_FIELD_DEFINITIONS: Readonly<Record<DocumentType, readonly InputFieldDefinition[]>> = {
  ...
  "S-Layout": [
    { key: "screens.name", defaultLabel: "画面名" },
    { key: "screens.image", defaultLabel: "画面画像" },
    { key: "screens.notes", defaultLabel: "備考" },
    { key: "screenItems.itemName", defaultLabel: "項目名称" },
    { key: "screenItems.type", defaultLabel: "タイプ" },
    { key: "screenItems.io", defaultLabel: "I/O" },
    { key: "screenItems.length", defaultLabel: "桁数" },
    { key: "screenItems.required", defaultLabel: "必須" },
    { key: "screenItems.screenMode1", defaultLabel: "画面モード1" },
    { key: "screenItems.screenMode2", defaultLabel: "画面モード2" },
    { key: "screenItems.screenMode3", defaultLabel: "画面モード3" },
    { key: "screenItems.separator", defaultLabel: "-" },
    { key: "screenItems.notes", defaultLabel: "備考" },
    { key: "screenItems.focusMessage", defaultLabel: "フォーカス時メッセージ" },
    { key: "screens.footer", defaultLabel: "フッター" },
  ],
  "R-Layout": [
